<div class="app-shell">
    <header class="topbar">
        <div>
            <div class="brand">Stock Removal</div>
            <div class="muted" style="color: #b8c6cf;">Migrated from `stock_remove.php`</div>
        </div>
    </header>
    ...
    <div class="shell-grid">
        ...
        <main class="page">
            ...
            <div class="grid">
                <section class="card">
                    <h2>Search Stock to Remove</h2>
                    <form method="POST" action="/stock/remove/search" class="stack">
                            ...
                            <tbody>
                                <?php foreach ($candidates as $candidate): ?>
                                    <tr>
                                        ...
                                        <td><?= htmlspecialchars((string) ($candidate["stock_add_dt"] ?? ""), ENT_QUOTES, "UTF-8") ?></td>
                                        <td colspan="2">
                                            <form method="POST" action="/stock/remove/submit" style="display:flex; gap:12px; align-items:center;">
                                                <input type="hidden" name="_token" value="<?= htmlspecialchars(csrf_token(), ENT_QUOTES, "UTF-8") ?>">
                                                ...
                                                <input type="text" class="input" name="reason" placeholder="Reason for removal" required style="flex-grow: 1;">
                                                <button class="btn btn-danger" type="submit" onclick="return confirm('Are you sure you want to permanently remove this stock?');">Remove Stock</button>
                                            </form>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
