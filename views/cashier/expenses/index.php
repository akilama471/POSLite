<div class="app-shell">
    <header class="topbar">
        <div>
            <div class="brand">Add Expense</div>
            <div class="muted" style="color: #b8c6cf;">Migrated from `shop_openbalance.php` & `expence_account.php`</div>
        </div>
    </header>
        ...
        <main class="page">
            ...
            <div class="grid" style="grid-template-columns: 1fr 1fr; gap: 24px;">
                <section class="card">
                    ...
                    <form method="POST" action="/cashier/expenses" class="stack">
                        ...
                        <div class="muted" style="margin-top: 12px; font-size: 0.9em;">
                            Please add all non-system billed expenses here to avoid unbalancing the cash flow.
                        </div>
                    </form>
                </section>
                ...
                <div class="stack" style="gap: 24px;">
                    <?php if (can("p_60")): ?>
                        <section class="card">
                            ...
                            <form method="POST" action="/cashier/expenses/accounts" class="stack" style="flex-direction: row; align-items: flex-end; gap: 12px;">
                                <input type="hidden" name="_token" value="<?= htmlspecialchars(csrf_token(), ENT_QUOTES, "UTF-8") ?>">
                                <div style="flex: 1;">
                                ...
                                <table class="data-table">
                                    ...
                                    <tbody>
                                        <?php if (empty($accounts)): ?>
                                            <tr>
                                                <td colspan="2" class="text-center muted">No expense accounts found.</td>
                                            </tr>
                                        <?php else: ?>
                                            <?php foreach ($accounts as $acc): ?>
                                                <tr>
...
function editAccount(id, name) {
    ...
    form.action = `/cashier/expenses/accounts/${id}/update`;
    input.value = name;
