<div class="app-shell">
    <header class="topbar">
        <div>
            <div class="brand">Stock Delete Log</div>
            <div class="muted" style="color: #b8c6cf;">Migrated from `rpt_logs_stockremv.php`</div>
        </div>
    </header>
        ...
        <main class="page">
            ...
            <section class="card stack print-area" id="report-container" style="display:none; min-height:400px;">
                <div style="text-align:center; margin-bottom:24px;">
                    <h2 style="margin-bottom:4px;">Stock Removal / Delete History</h2>
...
async function loadReport() {
    ...
    fd.append('type','logs_stock_delete'); fd.append('from_date',from); fd.append('to_date',to);
    ...
    document.getElementById('report-subtitle').textContent = `Stock removals from ${from} to ${to}`;
